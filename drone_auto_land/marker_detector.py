...
class MarkerDetector(Node):
    def __init__(self):
        ...
        self.warped_pub = self.create_publisher(Image, 'warped', 10)
        self.warped_threshold_pub = self.create_publisher(Image, 'warped_threshold', 10)
        self.bits_image_pub = self.create_publisher(Image, 'bits_image', 10)
        ...
        self.marker_size = 0.50
        self.embedded_marker_size = 0.071
        ...
        #debug
        self.adaptive_threshold_image_debug = None
        self.contours_debug = None
        self.countours_filtered_debug = None
        self.warped_debug = None
        self.marker_bits_debug = None
        self.count_debug = 0
        self.erroneous_bits_marker_debug = None
